<script>
	$(document).ready(function() {
		...
		$(".simpan").click(function(){
			window.location="<?php echo site_url('mahasiswa/formmahasiswa');?>";
			return false;
		});
		$(".ubah").click(function(){
			var id= $(".bg-gray").attr("href");
			window.location="<?php echo site_url('mahasiswa/formmahasiswa');?>/"+id;
			return false;
		});
		...
		$(".ya").click(function(){
			var id=$(".bg-gray").attr("href");
			window.location="<?php echo site_url('mahasiswa/hapusmahasiswa');?>/"+id;
		});
...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			<?php echo form_open('mahasiswa',array("id"=>"formsubmit"));?>
